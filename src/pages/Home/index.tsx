...
export default function Home(){
    ...
    useEffect(()=>{ upadateTechToWork() },[isCreateTech ,isUpdateTech, isCreateWork, isUpdateWork])
            ...
            <HomeStyled>
                ...
                <Modal borderBottom height={74}>
                    <Navgation 
                        onTech={changeTech} 
                        onWork={changeWork} 
                        onCreateTechOrWork={ type === "Tech" ? openCreateTech : openCreateWork }/>
                </Modal>
                <Modal height={32}>
                    <Modal 
                        height={32} 
                ...
                <Modal maxWidth="large" paddingPosition={{x:true}}>
                    ...
                    >   
                    {
                        type === "Tech" ?
                            ...
                            :
                            <AddToPhotosTwoToneIcon fontSize="large"/>
                        :   
